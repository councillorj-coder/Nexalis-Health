...
export const marketingData: Record<string, MarketingProduct> = {
    ...
    synergy: 'Caliber™ is the external counterpart to Meridia™ and the tactical partner to Cinder™. By establishing your structural baseline, Caliber™ allows Cinder™ to interpret change with absolute precision. It’s the "Calibration Gate" that makes the rest of the ecosystem smarter.',
    ...
    hook: 'The health of your most private physiology is a story told over years, not snapshots. Cinder™ lives with you, capturing the subtle rhythms of your life without ever being felt.',
    theExperience: 'Cinder™ is the ultimate "set and forget" wearable. Crafted from medical-grade, soft-touch silicone, it sits passively at the core of your physiological life. It doesn’t ask for attention. Instead, it works in the background, measuring response timing, structural stability, and thermal context. Over weeks and months, it builds a "Bio-Profile"—a longitudinal map of your vitality and recovery that alerts you to meaningful shifts before they become concerns.',
    synergy: 'Cinder™ is the "Tactical Node." While Compass™ monitors your heart and stress, Cinder™ monitors the specific physiological outcomes. They work in a closed-loop: Compass™ tells the system you’re stressed, and Cinder™ shows how that stress affects your intimate health. It’s the full story, finally connected.',
    trust: 'Data is identity. Cinder™ anonymizes your signals at the source. The system doesn’t store your raw arousal waves; it stores indices of health and patterns of recovery. You own the insights; we provide the protection.',
