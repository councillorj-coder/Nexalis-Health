    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-blue-500/30 font-sans leading-relaxed overflow-x-hidden">
            ...
            <main className="py-16 px-8 max-w-3xl mx-auto space-y-16 text-center">
                {/* Title */}
                <h1 className="text-7xl font-black">Cinder™</h1>
                ...
                <div className="space-y-4">
                    <h2 className="text-4xl font-black">Cinder™</h2>
                ...
                <div className="space-y-8 pt-8 border-t border-white/10">
                    ...
                    <p className="text-base text-slate-400 leading-relaxed">
                        Erectile dysfunction develops gradually, through changes in rigidity, stability, and response over time, yet it is typically evaluated using brief clinical tests, questionnaires, or artificial stimulation that capture only isolated moments. This makes early changes difficult to detect and long-term patterns hard to understand. Because erectile function is continuous and sensitive to real-world conditions, meaningful measurement requires passive, non-invasive sensing that operates without user input or visual anatomical capture. Cinder was designed to meet clinical measurement standards first, while also enabling individuals to track erectile health, performance, and recovery over time as part of broader wellness monitoring.
                    </p>
                </div>
                ...
                <div className="space-y-8 pt-8 border-t border-white/10">
                    ...
                    <div className="space-y-6">
                        <p className="text-base text-slate-400 leading-relaxed">
                            Cinder does not measure anatomy or performance outcomes.<br />
                        ...
                        <p className="text-base text-slate-400 leading-relaxed pt-4">
                            Cinder provides signal-level insight, not diagnosis, enabling clinical interpretation and long-term personal monitoring within a broader health and wellness framework.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-8 pt-8 border-t border-white/10">
                    ...
                    <p className="text-base text-slate-400 leading-relaxed">
                        Cinder is designed as a single-purpose, clinical-grade sensing node, optimized for passive wear, signal stability, and long-term durability.
                    </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-slate-400">Cinder is offered in two size profiles to accommodate the general population while preserving measurement integrity:</p>
                        <div className="space-y-3 text-left">
                            <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-slate-400">Cinder hardware is designed to be:</p>
                        <ul className="text-sm text-slate-400 space-y-2 list-disc list-inside text-left">
                ...
                <div className="space-y-8 pt-8 border-t border-white/10">
                    ...
                    <p className="text-base text-slate-400 leading-relaxed">
                        Cinder moves data through a simple, controlled pipeline, from physical signal capture to longitudinal insight. Privacy is maintained through data minimization, non-visual sensing, and protected user profiles.
                    </p>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3 text-left">
                            ...
                            <ul className="text-sm text-slate-400 space-y-1 list-disc list-inside">
                                <li>Cinder transmits raw sensor inputs via Bluetooth Low Energy to the companion application</li>
                ...
                <div className="space-y-8 pt-8 border-t border-white/10">
                    ...
                    <div className="space-y-6">
                        <p className="text-base text-slate-400 leading-relaxed">
                            Cinder serves as the foundational sensing node within the Nexalis ecosystem.
                        </p>
                        ...
                        <div className="space-y-3 text-left">
                            <p className="text-base text-white font-semibold">Within the Nexalis system, Cinder:</p>
                        ...
                        <p className="text-base text-slate-400 leading-relaxed">
                            Cinder is intentionally focused on signal acquisition, not diagnosis or interpretation. This separation allows higher-level Nexalis software layers to evolve independently, incorporating additional physiological inputs, clinical frameworks, and personalized models over time.
                        </p>

                        <p className="text-base text-slate-400 leading-relaxed">
                            As the first sensing node, Cinder sets the standard for how data is collected, abstracted, and integrated across the Nexalis platform—forming the basis for future devices, insights, and system-level intelligence.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-8 pt-8 border-t border-white/10">
                    ...
                    <div className="space-y-6">
                        <p className="text-base text-white font-semibold">
                            Cinder is currently in the pre-development phase.
                        </p>
                        ...
                        <p className="text-base text-slate-400 leading-relaxed italic">
                            Cinder is being presented now to invite early technical and clinical collaboration, not as a finished or partially implemented product.
                        </p>
                    </div>
                </div>
            ...
            <footer className="py-12 px-8 border-t border-white/10 text-center text-xs text-slate-700">
                © 2026 Nexalis Health. Cinder is a wellness device.
            </footer>
